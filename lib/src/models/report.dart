...
class Report {
  ...
  Report.map(dynamic data) {
    ...
    this.comentario = data.containsKey('comentario')? data['comentario'].toString() : "";
    this.calificacion = data.containsKey('calificacion')? data['calificacion'].toString() : "";
    this.fecha = data.containsKey('fecha')? data['fecha'].toString() : "";
    this.userId = data.containsKey('user_id')? data['user_id'].toString() : "";
    this.pistaId = data.containsKey('pista_idpista')? data['pista_idpista'].toString() : "";
    this.reporteDe = data.containsKey('reporte_de')? data['reporte_de'].toString() : "";

    this.titulo = data.containsKey('titulo')? data['titulo'].toString() : "";
    this.borrador = data.containsKey('borrador')? data['borrador'].toString() : "";
    this.ubicacion = data.containsKey('ubicacion')? data['ubicacion'].toString() : "";
    this.calidadNieve = data.containsKey('calidad_nieve')? data['calidad_nieve'].toString() : "";
    this.esperaMedios = data.containsKey('espera_medios')? data['espera_medios'].toString() : "";
    ...
    this.pista = data.containsKey('pistaSki')? Pist.map(data['pistaSki']) : null;
