class User {
  ...
  User(this.id, this.username, this.email, this.status, this.createdAt, this.updatedAt, this.token, this.nombre,
         ...
         this.visible, this.ranking, this.facebookUserId, this.instagramUserId, this.localidad, this.fullname);
  ...
  User.map(dynamic data) {
    ...
    this.apellidos = data.containsKey('apellidos')? data['apellidos'].toString() : "";
