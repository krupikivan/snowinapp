...
import 'package:snowin/src/utils/instagram.dart';
...
abstract class LoginViewContract {
  void onLoginScuccess(instagram.Token token);
...
class LoginPresenter {
  ...
  void perform_login() {
    assert(_view != null);
    instagram.getToken(Config.instagramAppId, Config.instagramAppSecret).then((token)
    {
      if (token != null) {
