                  ...
                  child: Stack(
                    children: [
                      Container(
                        ...
                        child: Image(
                          fit: BoxFit.cover,
                          image: NetworkImage("https://skisnowstar.com/files/2019/11/feature1_1.jpg"),
                        ),
                      ),
                      Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(fontSize: 22, fontWeight: FontWeight.normal, color: Color.fromRGBO(140, 140, 139, 1)),
                        ...
                        child: RaisedButton(
                          ...
                          child: Row(
                            ...
                            children: [
                              SizedBox(width: 10,),
                              SizedBox(width: 10,),
                              Text("Ingresar", style: TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.bold),),
                              SizedBox(width: 10,),
