...
class FriendTileMap extends StatefulWidget {
  final User friend;
  final AfterSendCallback afterSend;

  FriendTileMap({ Key key, this.friend, this.afterSend}) : super(key: key);

  @override
  FriendTileMapState createState() => new FriendTileMapState(friend);
}

class FriendTileMapState extends State<FriendTileMap> {
  User friend;

  FriendTileMapState(this.friend);
